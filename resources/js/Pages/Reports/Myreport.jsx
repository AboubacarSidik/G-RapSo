...
export default function Myreport({auth, reports, queryParams = null, success}) {
                    ...
                    <tr className="text-nowrap">
                      ...
                      <th className="px-3 py-3">
                        ...
                        //   defaultValue={queryParams.name}
                          placeholder="Thème du rapport"
                          onBlur={(e) =>
                            searchFieldChanged("theme", e.target.value)
                          }
                  ...
                  <tbody>
                    {reports.data.map((report) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 text-nowrap">
                          <Link
                            href={route("reports.showmine", report.id)}
